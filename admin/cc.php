...
$consulta = "SELECT * FROM admi WHERE cedula = '$admin'";
...
<html dir="ltr" lang="en">
 ...
 &nbsp;
    ...
    <form action="modif_cc.php" method="POST">

 <label>Nombre</label>
      <input type="name" id="name" style="width : 24.9%; text-align: center;" name="nombre" value="<?php echo $nombre; ?>" disabled><br>
      
      <label>Cedula</label>
      <input type="number" id="cedula" style="width : 25.4%; text-align: center;" name="ced" value="<?php echo $cedula; ?>" disabled>

      <br>
       <label>Contraseña nueva</label>
      <input type="password" id="password" placeholder="********" style="width : 20%; text-align: center;"  name="contrasenanueva" required><br>
