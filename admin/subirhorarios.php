...
<section class="columns">
	...
	<div class="column">
		<h2 style="text-align: center">Horarios semana</h2>
    <center><a href="plantillahorarios.csv"> <small> Descargar plantilla </small></a></center>
		<p>
    <form action="recibe_horarios.php" method="POST" enctype="multipart/form-data"/>
	...
	<div class="column">
		<h2 style="text-align: center">Horarios sábado</h2>
    <center><a href="plantillasabado.csv"> <small> Descargar plantilla </small></a>
		<p>
    <form action="recibe_horariossabado.php" method="POST" enctype="multipart/form-data"/>
  ...
  <div class="column">
		<h2>Mensaje horarios</h2>
		<p>
    <form action="guardah.php" method="POST">
         
         <div>
         <textarea placeholder="<?php // echo $mensaje; ?>" rows="3px" cols="40" name="mensaje"></textarea>
         </div>
 
     <center> <button style="margin-top: 7px;" type="submit" class="btn btn-success"> Guardar</button></center>
        </form> 
    </p>
...
<?php if($dia=='5') { 
if($hora>='10') { ?>
  <h4> Plazo maximo para subir horario los dias viernes a las 10:00am
  <?php } else {
date_default_timezone_set("America/Bogota");

$manana = date("Y-m-d 10:00:00");
...
$s = sprintf('%0d',$s);
  ?>
<h4> Usted cuenta con <b><?php echo $h; ?> horas </b> y <b><?php echo $m; ?> minutos</b> para subir los horarios.</h4>

<?php }} else { echo "<h4> Plazo maximo para subir horario los dias viernes a las 10:00am </h4>"; } ?>

     <a href="/Login/panelagente/horarios.php" target="_blank"> <h6 class="text-center">
  
          <strong>Ver Horarios </strong> </a>
        </h6>
