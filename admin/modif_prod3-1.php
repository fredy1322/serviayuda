...
?>
  ...
  <div id="contenido">
    <div style="margin: auto; width: 800px; border-collapse: separate; border-spacing: 10px 5px;">
      <span> <h1>Inhabilitar agente</h1> </span>
      <br>
    <form action="modif_prod4.php" method="POST">
    <input type="hidden" name="ID"; value="<?php echo $ID?>"><br>
      
      <label> Nombre: </label>
      <input type="text" id="nombre" style="width : 45%; text-align: center;"  name="nombre"; value="<?php echo $nombre; ?>" readonly><br>
      
      <label>Cedula: </label>
      <input type="number" id="cedula" style="width : 46%; text-align: center;" name="cedula" value="<?php echo $cedula ?>" readonly><br>
      <label><b>Fecha RETIRO:</b></label>
      <input type="date" id="cedula" style="width : 42%; text-align: center;" name="fecharetiro" requiere><br>
      <label>Motivo de retiro: </label>
      <select type="date" id="motivo" style="width : 42%; text-align: center;" name="motivo" requiere>
...
<input type="hidden" name="cedula"; value="<?php echo $cedula ?>"><br>
      <div style="margin-top: -8.9%; margin-left: 10.5%;">
          </div>
        </form>
        <form action="desenganchar.php" method="POST">
<input type="hidden" name="cedula"; value="<?php echo $ce ?>"><br>
