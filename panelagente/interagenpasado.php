...
$desde = $numeroañoactual."-0".$numeromespasado."-01";
$hasta = $numeroañoactual."-0".$numeromespasado."-31";
...
<link rel="stylesheet" href="/Login/Aplicativo/css/estilograficoagente.css">
