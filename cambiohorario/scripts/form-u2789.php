...
$form = array(
	...
	'fields' => array(
		...
		'custom_U2794' => array(
			...
			'required' => true,
			'errors' => array(
				'required' => 'El campo \'Nombre del agente\' es obligatorio.'
			)
		),
		'Email' => array(
			'order' => 3,
			'type' => 'email',
			'label' => 'Su horario actual es',
			'required' => true,
			'errors' => array(
				'required' => 'El campo \'Su horario actual es\' es obligatorio.',
				'format' => 'El campo \'Su horario actual es\' contiene un correo electrónico no válido.'
			)
		)
	)
);
