...
include('db.php');
include('session.php');
include('acciones/aceptacion.php');
?>
...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.musepolyfill.bgsize.js", "webpro.js", "jquery.watch.js", "jquery.museresponsive.js", "require.js", "aceptacion.css"], "outOfDate":[]};
 ...
 <body>
 <form style="z-index:1000000" class="form-grp clearfix grpelem temp_no_id" method="post" enctype="multipart/form-data" action="acciones/agenteacepta.php">
    ...
    <div class="rounded-corners clearfix grpelem" id="u3186"><!-- column -->
     <div class="position_content" id="u3186_position_content">
      ...
      <div class="rounded-corners clearfix colelem" id="u3163"><!-- column -->
       ...
       <p class="colelem temp_no_id temp_no_img_src" alt="" style="font-size:20px; padding:7px" width="746" height="69" data-orig-src="images/u3187-72.png?crc=421859312" data-orig-id="u3187-7" src="images/blank.gif?crc=4208392903" style="font-size: 18px"> Seleccione los dias a cambiar, para saber el agente y el nuevo horario relacionado con la solicitud debe pasar el mouse encima del dia habilitado. </p><!-- rasterized frame -->      </div>
     </div>
    </div>
...
Aceptacion
    ...
    <div class="rounded-corners clearfix grpelem" id="u3165" style="height: 42% !important;"><!-- column -->
     <div class="position_content" id="u3165_position_content">
      <div class="clearfix colelem" id="pu3183-4"><!-- group -->
       ...
       <img class="grpelem temp_no_img_src" id="u3188-4" alt="¿Acepta el cambio de horario?" width="358" height="33" data-orig-src="images/u3188-4.png?crc=4086196636" src="images/blank.gif?crc=4208392903"/><!-- rasterized frame -->
        ...
        <button name="resultado" class="submit-btn NoWrap rounded-corners clearfix grpelem" id="u3321-3" type="submit" value="acepta" tabindex="8"><!-- content -->
         <div style="margin-top:0px;height:12px; font-size:20; color:white;" class="shared_content" data-content-guid="-3_0_content">
          <p>Aceptar</p>
         </div>
        </button>
        <button name="resultado" class="submit-btn NoWrap rounded-corners clearfix grpelem" class="" type="submit" value="rechaza" tabindex="8"><!-- content -->
         <div class="rechazar">
          <p>Rechazar</p>
         </div>
        </button>
        ...
        <div class="fld-grp clearfix grpelem" id="widgetu3373" data-required="false" data-type="checkbox"><!-- none box -->
         ...
         <div class="fld-checkbox museBGSize grpelem" id="u3392"><!-- simple frame -->
          <input class="wrapped-input shared_content" type="checkbox" value="lunes" id="widgetu3373_input" name="lunes" tabindex="4" data-content-guid="widgetu3373_input_content" <?php if(empty($solicitantelunes)) { echo "disabled"; } ?>/>
        ...
        <div class="fld-grp clearfix grpelem" id="widgetu3458" data-required="false" data-type="checkbox"><!-- none box -->
         ...
         <div class="fld-checkbox museBGSize grpelem" id="u3460"><!-- simple frame -->
          <input class="wrapped-input shared_content" type="checkbox" value="martes" id="widgetu3458_input" name="martes" tabindex="2" data-content-guid="widgetu3458_input_content" <?php if(empty($solicitantemartes)) { echo "disabled"; } ?>/>
        ...
        <div class="fld-grp clearfix grpelem" id="widgetu3482" data-required="false" data-type="checkbox"><!-- none box -->
         ...
         <div class="fld-checkbox museBGSize grpelem" id="u3483"><!-- simple frame -->
          <input class="wrapped-input shared_content" type="checkbox" value="miercoles" id="widgetu3482_input" name="miercoles" tabindex="5" data-content-guid="widgetu3482_input_content" <?php if(empty($solicitantemiercoles)) { echo "disabled"; } ?>/>
        ...
        <div class="fld-grp clearfix grpelem" id="widgetu3506" data-required="false" data-type="checkbox"><!-- none box -->
         ...
         <div class="fld-checkbox museBGSize grpelem" id="u3507"><!-- simple frame -->
          <input class="wrapped-input shared_content" type="checkbox" value="jueves" id="widgetu3506_input" name="jueves" tabindex="3" data-content-guid="widgetu3506_input_content"<?php if(empty($solicitantejueves)) { echo "disabled"; } ?>/>
        ...
        <div class="fld-grp clearfix grpelem" id="widgetu3530" data-required="false" data-type="checkbox"><!-- none box -->
         ...
         <div class="fld-checkbox museBGSize grpelem" id="u3531"><!-- simple frame -->
          <input class="wrapped-input shared_content" type="checkbox" value="viernes" id="widgetu3530_input" name="viernes" tabindex="6" data-content-guid="widgetu3530_input_content"<?php if(empty($solicitanteviernes)) { echo "disabled"; } ?>/>
        ...
        <div class="fld-grp clearfix grpelem" id="widgetu3554" data-required="false" data-type="checkbox"><!-- none box -->
         ...
         <div class="fld-checkbox museBGSize grpelem" id="u3555"><!-- simple frame -->
          <input class="wrapped-input shared_content" type="checkbox" value="sabado" id="widgetu3554_input" name="sabado" tabindex="7" data-content-guid="widgetu3554_input_content" <?php if(empty($solicitantesabado)) { echo "disabled"; } ?>/>
   ...
   <div class="preload_images">
    ...
    <img class="preload temp_no_img_src" dateleccia-orig-src="images/checkboxchecked.jpg?crc=477278992" alt="" src="images/blank.gif?crc=4208392903"/>
  ...
  <div class="breakpoint" id="bp_1366" data-max-width="1366"><!-- responsive breakpoint node -->
   <div class="clearfix temp_no_id" data-orig-id="page"><!-- group -->
    ...
    <div class="rounded-corners clearfix grpelem temp_no_id" data-orig-id="u3165" style="height: 40% !important; width: 62%"><!-- column -->
     <div class="clearfix colelem temp_no_id" data-orig-id="pu3183-4"><!-- group -->
      ...
      <!-- none box -->
       ...
       <button name="resultado"class="submit-btn NoWrap rounded-corners clearfix grpelem temp_no_id rechazar" type="submit" value="acepta"  tabindex="16" data-orig-id="u3321-3"><!-- content -->
       <div class="">
       <p> Aceptar </p>
      </div>
      </button>
       <button name="resultado"class="submit-btn NoWrap rounded-corners clearfix grpelem temp_no_id rechazar2" type="submit" value="rechaza"  tabindex="16" data-orig-id="u3321-44"><!-- content -->
